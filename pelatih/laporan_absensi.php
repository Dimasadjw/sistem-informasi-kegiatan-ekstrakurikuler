...
if (isset($_POST['submit'])) {
    ...
    if ($tanggal_mulai > $tanggal_selesai) {
        ...
        $query = "SELECT * FROM absensi a join tb_user b on a.id_user= b.id_user join tb_ekstra c on a.id_ekstra = c.id WHERE waktu_absen BETWEEN '$tanggal_mulai' AND '$tanggal_selesai' AND c.id_user = '$id_user'";
